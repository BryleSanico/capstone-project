...
// Define the types for route and navigation for THIS screen
...
export default function TicketDetailsScreen() {
  ...
  const handleShareTicket = async () => {
    try {
      await Share.share({
        message: `My ticket for ${ticket.eventTitle} on ${formatDate(ticket.eventDate)}`,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        >
          ...
          <View style={styles.priceSection}>
            <Text style={styles.totalPaid}>Total Paid: ${ticket.totalPrice.toFixed(2)}</Text>
          </View>
        </LinearGradient>
        ...
        <View style={styles.infoSection}>
          ...
          <Text style={styles.infoText}>
            ...
            • This QR code is your entry ticket - keep it safe{'\n'}
            • Screenshots of this ticket are valid{'\n'}
